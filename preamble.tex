...
% Other packages %
%%%%%%%%%%%%%%%%%%
\usepackage{nicefrac,fancyhdr,hyperref,graphicx,adjustbox, underscore}
\definecolor{dark_blue}{rgb}{0.039, 0.039, 0.361}
% \definecolor{dark_blue}{rgb}{255, 0, 172}
\hypersetup{
  colorlinks=true,
  urlcolor=blue,
  citecolor=blue,
...
% Tensor
\newcommand{\ten}[1]{\mathsf{\boldsymbol{#1}}}
...
% \definecolor{yellow}{HTML}{EBD234}
\definecolor{yellow}{HTML}{D4C222}
...
\newenvironment{conj}{\begin{tcolorbox}[
  arc=0mm,
  left=2pt,
  right=2pt,
  top=2pt,
...
\newenvironment{question}[1]{\begin{tcolorbox}[
  arc=0mm,
  left=2pt,
  right=2pt,
  top=2pt,
